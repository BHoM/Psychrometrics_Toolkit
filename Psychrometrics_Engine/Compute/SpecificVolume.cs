...
namespace BH.Engine.Psychrometrics
{
    ...
    {
        [Description("Calculates specific volume from dry-bulb temperature, pressure and one of: humidityRatio, relativeHumidity or wetBulbTemperature.")]
        ...
        public static double SpecificVolume(double dryBulbTemperature, double pressure, double humidityRatio = double.MinValue, double relativeHumidity = double.MinValue, double wetBulbTemperature = double.MinValue)
        {
            ...
            if (humidityRatio != double.MinValue)
            {
                ...
                {
                    BH.Engine.Base.Compute.RecordWarning($"Warning: This function is prioritising humidityRatio for calculating specificVolume. If you want to use a different parameter, remove humidityRatio.");
                }
            ...
            else if (relativeHumidity != double.MinValue)
            {
                ...
                {
                    BH.Engine.Base.Compute.RecordWarning($"Warning: This function is prioritising relativeHumidity for calculating specificVolume. If you want to use wetBulbTemperature, remove relativeHumidity.");
                }
